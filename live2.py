...
# ==============================
# 2. MODEL TRAINING (Decision Tree + Nifty)
# ==============================
...
def train_ipo_model(nifty, nifty_feature_cols):
    ...
    try:
        ...
        # Normalize and merge with Nifty
        ...
        print(f"Model trained successfully ✅  (Test Accuracy: {acc}%)")
        print("\n===== MODEL PERFORMANCE =====")
...
def run():
    ...
    # Step 2: Train Decision Tree with Nifty features
    model, all_features = train_ipo_model(nifty, nifty_feature_cols)
    if not model:
        return

    # Step 3: Latest Nifty snapshot for live predictions
    ...
    for ipo in open_ipos:
        ...
        prob     = model.predict_proba(live_input)[0][1]
